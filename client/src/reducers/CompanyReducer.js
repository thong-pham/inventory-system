import { ADD_COMPANY_STARTED, ADD_COMPANY_FULFILLED, ADD_COMPANY_REJECTED } from "./../actions/CompanyActions";
import { GET_COMPANIES_STARTED, GET_COMPANIES_FULFILLED, GET_COMPANIES_REJECTED } from "./../actions/CompanyActions";
import { DELETE_COMPANY_STARTED, DELETE_COMPANY_FULFILLED, DELETE_COMPANY_REJECTED } from "./../actions/CompanyActions";
import { GET_PENDING_COMPANIES_STARTED, GET_PENDING_COMPANIES_FULFILLED, GET_PENDING_COMPANIES_REJECTED } from "./../actions/CompanyActions";
import { UPDATE_COMPANY_STARTED, UPDATE_COMPANY_FULFILLED, UPDATE_COMPANY_REJECTED } from "./../actions/CompanyActions";
import { SET_UPDATING_COMPANY_FULFILLED } from "./../actions/CompanyActions";

...
import { getInventoriesInTrash, recoverInventory, deleteInventoryInTrash } from "./../../actions/SubInventoryActions";

class ViewSubTrash extends Component {
...
export default connect(mapStatesToProps)(ViewSubTrash);
